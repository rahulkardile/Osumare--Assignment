...
const Details = () => {
  return (
    <div className='w-screen my-20'>
      ...
      <div className="flex flex-row portrait:flex-col portrait:text-center m-auto gap-3 w-[80vw]">
        <img className='w-[37vw] portrait:w-[80vw] portrait:m-auto' src={logo} alt="img" />
        <div className="p-4">
